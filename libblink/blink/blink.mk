...
BLINK_CXX_SRCS = $(filter %.cpp,$(BLINK_FILES))
BLINK_HDRS = $(filter %.h,$(BLINK_FILES))
BLINK_SRCS = $(filter %.c,$(BLINK_FILES))
BLINK_OBJS = $(BLINK_SRCS:%.c=o/$(MODE)/%.o)
BLINK_CXX_OBJS = $(BLINK_CXX_SRCS:%.cpp=o/$(MODE)/%.o)
...
o/$(MODE)/blink/blinkenlib.js: o/$(MODE)/blink/blinkenlib.o o/$(MODE)/blink/blinkenlib_bindings.o o/$(MODE)/blink/blink.a $(ZLIB)
