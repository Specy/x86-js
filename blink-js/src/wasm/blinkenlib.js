...
var _blinkenlib_faketty_resume = Module['_blinkenlib_faketty_resume'] = makeInvalidEarlyAccess('_blinkenlib_faketty_resume');
...
function assignWasmExports(wasmExports) {
  ...
  assert(wasmExports['blinkenlib_faketty_resume'], 'missing Wasm export: blinkenlib_faketty_resume');
  _blinkenlib_faketty_resume = Module['_blinkenlib_faketty_resume'] = createExportWrapper('blinkenlib_faketty_resume', 0);
